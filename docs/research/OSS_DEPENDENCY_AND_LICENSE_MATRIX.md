...
| [WaveSurfer.js 7.12.11](https://github.com/katspaugh/wavesurfer.js/tree/7.12.11) | Browser playback, precomputed waveform, timeline, zoom, and preview audition regions | **Verified 2026-08-24.** BSD-3-Clause; exact npm tarball SHA-256 and license archived; no runtime dependencies | **Production candidate / current technical lead**; v8.0.0-beta.3 rejected for the live pin while prerelease | Real 1–3 hour browser, timing/VBR, accessibility, multichannel, and mobile tests before approved status |
